...
/// property using the `@ContextEntry` macro.
///
/// ```swift
...
extension OperationContext {
  ...
  /// context property through the `@ContextEntry` macro. The `@ContextEntry` macro automatically
  /// generates a type that conforms to this protocol.
  ///
  /// ```swift
  /// extension OperationContext {
  ///   @ContextEntry var myProperty = "test"
  ///
  ///   // Generated by @ContextEntry
  ///   private enum __Key_myProperty: Key {
